...
const UpdatePostScreen = ({ location, history,match }) => {
    ...
    }, [dispatch,history,post_id,post,successUpdatePosts])
    ...
    const notify = () => toast.success('🦄 Post Updated Successfully,Redirecting', {
        position: "top-right",
        autoClose: 5000,
                    ...
                    <Col md={8} xs={12} className="col-md-offset-2">
                        <Col className="mainheading">
                            ...
                            <Row className=" post-top-meta">
                                ...
                                <Col md={10}>
                                    <a className="link-dark" href="author.html">{author}</a>
                                    <span
                                        className="author-description"></span>
